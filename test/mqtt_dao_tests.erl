...
create(X, Storage) -> {"create [" ++ atom_to_list(X) ++ "]", timeout, 1, fun() ->
	Storage:save(client, #storage_publish{key = #primary_key{client_id = "lemon", packet_id = 101}, document = #publish{topic = "AK", payload = <<"Payload lemon 1">>}}),
 	...
 	Storage:save(client, #storage_subscription{key = #subs_primary_key{topic = "AKtest", client_id = "lemon"}, qos = 0, callback = {erlang, timestamp}}),
 	Storage:save(client, #storage_subscription{key = #subs_primary_key{topic = "Winter/+", client_id = "orange"}, qos = 1, callback = {mqtt_client_test, callback}}),
 	Storage:save(client, #storage_subscription{key = #subs_primary_key{topic = "+/December", client_id = "apple"}, qos = 2, callback = {length}}),
 	Storage:save(client, #storage_subscription{key = #subs_primary_key{topic = "Winter/#", client_id = "pear"}, qos = 1, callback = {length}}),
 	Storage:save(client, #storage_subscription{key = #subs_primary_key{topic = "Winter/+/2", client_id = "plum"}, qos = 2, callback = {length}}),
 	Storage:save(client, #storage_subscription{key = #subs_primary_key{topic = "/+/December/+", client_id = "orange"}, qos = 2, callback = {length}}),
 	Storage:save(client, #storage_subscription{key = #subs_primary_key{topic = "+/December", client_id = "orange"}, qos = 0, callback = {size}}),
 	Storage:save(client, #storage_subscription{key = #subs_primary_key{topic = "+/December/+", client_id = "apple"}, qos = 0, callback = {length}}),
